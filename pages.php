<?php
  ...
  //$conn= $_SESSION["DBConnect"];
  $sql_query_pages="SELECT * FROM pages";
  $result=  $conn->query($sql_query_pages); 

  $num_pages= $result->num_rows;  
?>
                         ...
                         if ($result->num_rows>0){
                            while ($row = $result->fetch_assoc()) {
                              ...
                              echo "</td>
                                ...
                                echo $row['page_published']."</td>
                                <td><a class=\"btn btn-default\" href=\"edit.php?type=page&&id=".$row['page_id']."\">Edit</a> <a class=\"btn btn-danger\" href=\"#\">Delete</a></td>
                              </tr> ";
                            }
                         }
                      ?>
