<?php 
  ...
  $result=  $conn->query($sql_query_posts); 
                         ...
                         if ($result->num_rows>0){
                            while ($row = $result->fetch_assoc()) {
                              ...
                              echo "</td>
                                ...
                                echo $row['post_published']."</td>
                                <td><a class=\"btn btn-default\" href=\"edit.php?type=post&&id=".$row['post_id']."\">Edit</a> <a class=\"btn btn-danger\" href=\"#\">Delete</a></td>
                              </tr> ";
                            }
                         }
                      ?>
